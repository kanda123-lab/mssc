...
export default function SplitJsonPreviewPage() {
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                {[
                  { name: 'User Profile', json: '{"name":"John","age":30}' },
                  { name: 'API Response', json: '{"status":"success","data":[]}' },
                  { name: 'Config File', json: '{"theme":"dark","auto_save":true}' }
                ].map((example, index) => (
                  <button
                    key={index}
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1 max-h-24 overflow-y-auto">
                {[
                  { name: 'User Profile Data', time: '2h ago', valid: true },
                  { name: 'API Response', time: '1d ago', valid: true },
                  { name: 'Config Settings', time: '3d ago', valid: false }
                ].map((item, index) => (
