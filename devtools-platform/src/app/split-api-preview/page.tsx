...
export default function SplitApiPreviewPage() {
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                {[
                  ...
                  { name: 'REST API', method: 'GET', url: 'jsonplaceholder.typicode.com/posts/1' }
                ].map((example, index) => (
                  <button
                    key={index}
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1 max-h-20 overflow-y-auto">
                {[
                  ...
                  { name: 'Update Profile', method: 'PATCH', status: 200, time: '892ms' }
                ].map((request, index) => (
                  <div key={index} className="flex items-center justify-between px-2 py-1 hover:bg-gray-50 rounded text-xs cursor-pointer">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`px-1.5 py-0.5 text-xs rounded text-white ${
                        ...
                        request.method === 'POST' ? 'bg-green-500' : 'bg-orange-500'
                      }`}>
                        {request.method}
                      </span>
                    </div>
